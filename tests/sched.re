...
module Qc = {
  ...
  let unpack_is_inverse_of_pack_task_inst_uncompleted_store =
    QCheck.Test.make(
      ...
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Task_inst_id_map.of_seq;
        let y =
          x
  ...
  let unpack_is_inverse_of_pack_task_seg_uncompleted_store =
    QCheck.Test.make(
      ...
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Task_seg_id_map.of_seq;
        let y =
          x
  ...
  let unpack_is_inverse_of_pack_sched_req_pending_store =
    QCheck.Test.make(
      ...
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Sched_req_id_map.of_seq;
        let y =
          x
          |> Daypack_lib.Sched.Serialize.pack_sched_req_pending_store
          |> Daypack_lib.Sched.Deserialize.unpack_sched_req_pending_list;
  ...
  let unpack_is_inverse_of_pack_quota =
    QCheck.Test.make(
      ~count=5000,
      ~name="unpack_is_inverse_of_pack_quota",
      QCheck.(
        list_of_size(Gen.(int_bound(100)), pair(task_inst_id, pos_int64))
      ),
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Task_inst_id_map.of_seq;
        let y =
  ...
  let unpack_is_inverse_of_pack_task_seg_id_to_progress =
    QCheck.Test.make(
      ...
      QCheck.(
        list_of_size(Gen.(int_bound(100)), pair(task_seg_id, progress))
      ),
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Task_seg_id_map.of_seq;
        let y =
  ...
  let unpack_is_inverse_of_pack_user_id_to_task_ids =
    QCheck.Test.make(
      ...
      QCheck.(
        list_of_size(Gen.(int_bound(10)), pair(pos_int64, pos_int64_set))
      ),
      l => {
        let x = l |> List.to_seq |> Daypack_lib.User_id_map.of_seq;
        let y =
          x
          |> Daypack_lib.Sched.Serialize.pack_user_id_to_task_ids
          |> Daypack_lib.Sched.Deserialize.unpack_user_id_to_task_ids;
  ...
  let unpack_is_inverse_of_pack_task_id_to_task_inst_ids =
    QCheck.Test.make(
      ...
      QCheck.(
        list_of_size(Gen.(int_bound(10)), pair(task_id, pos_int64_set))
      ),
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Task_id_map.of_seq;
        let y =
  ...
  let unpack_is_inverse_of_pack_indexed_by_start =
    QCheck.Test.make(
      ...
      QCheck.(
        list_of_size(Gen.(int_bound(10)), pair(int64, task_seg_id_set))
      ),
      l => {
        let x = l |> List.to_seq |> Daypack_lib.Int64_map.of_seq;
        let y =
          x
          |> Daypack_lib.Sched.Serialize.pack_indexed_by_start
          |> Daypack_lib.Sched.Deserialize.unpack_indexed_by_start;
  ...
  let unpack_is_inverse_of_pack_sched_req_ids =
    QCheck.Test.make(
      ~count=5000,
      ~name="unpack_is_inverse_of_pack_sched_req_ids",
      pos_int64_set,
      x => {
        let y =
          x
  ...
  let add_diff_test_sched =
    QCheck.Test.make(
      ~count=50,
      ~name="add_diff_test_sched",
      QCheck.(pair(sched, sched)),
      ((old, x)) => {
        let diff = Daypack_lib.Sched.Diff.diff_sched(~old, x);
        Daypack_lib.Sched.Equal.sched_equal(
