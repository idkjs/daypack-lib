...
module Qc = {
  ...
  let add_diff_test_task_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_task_store",
      QCheck.(pair(task_store, task_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_id_map_utils.diff(~old, x);
        Daypack_lib.Task_id_map.equal(
          (x, y) => compare(x, y) == 0,
  ...
  let add_diff_test_task_inst_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_task_inst_store",
      QCheck.(pair(task_inst_store, task_inst_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_inst_id_map_utils.diff(~old, x);
        Daypack_lib.Task_inst_id_map.equal(
          (x, y) => compare(x, y) == 0,
  ...
  let add_diff_test_task_seg_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_task_seg_store",
      QCheck.(pair(task_seg_store, task_seg_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_seg_id_map_utils.diff(~old, x);
        Daypack_lib.Task_seg_id_map.equal(
          (x, y) => compare(x, y) == 0,
  ...
  let add_diff_test_sched_req_pending_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_sched_req_pending_store",
      QCheck.(pair(sched_req_store, sched_req_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Sched_req_id_map_utils.diff(~old, x);
        Daypack_lib.Sched_req_id_map.equal(
          (x, y) => compare(x, y) == 0,
  ...
  let add_diff_test_sched_req_record_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_sched_req_record_store",
  ...
  let add_diff_test_task_seg_id_to_progress =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_task_seg_id_to_progress",
  ...
  let add_diff_test_task_inst_id_to_progress =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_task_inst_id_to_progress",
  ...
  let add_diff_test_indexed_by_task_seg_id =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_test_indexed_by_task_seg_id",
  ...
  let sub_diff_test_task_inst_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_task_inst_store",
      QCheck.(pair(task_inst_store, task_inst_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_inst_id_map_utils.diff(~old, x);
        Daypack_lib.Task_inst_id_map.equal(
  ...
  let sub_diff_test_task_seg_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_task_seg_store",
      QCheck.(pair(task_seg_store, task_seg_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_seg_id_map_utils.diff(~old, x);
        Daypack_lib.Task_seg_id_map.equal(
  ...
  let sub_diff_test_sched_req_pending_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_sched_req_pending_store",
      QCheck.(pair(sched_req_store, sched_req_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Sched_req_id_map_utils.diff(~old, x);
        Daypack_lib.Sched_req_id_map.equal(
  ...
  let sub_diff_test_sched_req_record_store =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_sched_req_record_store",
      QCheck.(pair(sched_req_record_store, sched_req_record_store)),
      ((old, x)) => {
        let diff = Daypack_lib.Sched_req_id_map_utils.diff(~old, x);
        Daypack_lib.Sched_req_id_map.equal(
  ...
  let sub_diff_test_task_seg_id_to_progress =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_task_seg_id_to_progress",
      QCheck.(pair(task_seg_id_to_progress, task_seg_id_to_progress)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_seg_id_map_utils.diff(~old, x);
        Daypack_lib.Task_seg_id_map.equal(
  ...
  let sub_diff_test_task_inst_id_to_progress =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_task_inst_id_to_progress",
      QCheck.(pair(task_inst_id_to_progress, task_inst_id_to_progress)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_inst_id_map_utils.diff(~old, x);
        Daypack_lib.Task_inst_id_map.equal(
  ...
  let sub_diff_test_indexed_by_task_seg_id =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_test_indexed_by_task_seg_id",
      QCheck.(pair(indexed_by_task_seg_id, indexed_by_task_seg_id)),
      ((old, x)) => {
        let diff = Daypack_lib.Task_seg_id_map_utils.diff(~old, x);
        Daypack_lib.Task_seg_id_map.equal(
  ...
  let add_diff_bucketed_test_task_inst_id_to_task_seg_ids =
    QCheck.Test.make(
      ...
      QCheck.(
        pair(task_inst_id_to_task_seg_ids, task_inst_id_to_task_seg_ids)
      ),
      ((old, x)) => {
        let diff =
          Daypack_lib.Task_inst_id_map_utils.Int64_int64_option_bucketed.diff_bucketed(
  ...
  let add_diff_bucketed_test_indexed_by_start =
    QCheck.Test.make(
      ~count=5000,
      ~name="add_diff_bucketed_test_indexed_by_start",
  ...
  let sub_diff_bucketed_test_indexed_by_start =
    QCheck.Test.make(
      ~count=5000,
      ~name="sub_diff_bucketed_test_indexed_by_start",
      QCheck.(pair(task_seg_place_map, task_seg_place_map)),
      ((old, x)) => {
        let diff =
          Daypack_lib.Int64_map_utils.Task_seg_id_bucketed.diff_bucketed(
