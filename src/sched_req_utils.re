let sched_req_template_data_unit_matches_sched_req_data_unit =
    (
      ...
      sched_req_data_unit: Sched_req.sched_req_data_unit,
    )
    : bool =>
  switch (sched_req_template_data_unit, sched_req_data_unit) {
  | (
  ...
  | (
      Sched_req_data_unit_skeleton.Shift({
        task_seg_related_data_list: sizes1,
        time_slots: time_slots1,
        _,
      }),
      Sched_req_data_unit_skeleton.Shift({
        task_seg_related_data_list: task_segs,
  ...
  | (
    ...
    let sizes2 = List.map(((_, size)) => size, task_segs);
...
let sched_req_template_matches_sched_req =
    (
      sched_req_template: Task.sched_req_template,
      (_sched_req_id, sched_req_data): Sched_req.sched_req,
    )
    : bool =>
...
let sched_req_template_data_unit_matches_sched_req_record_data_unit =
    ...
    : bool =>
  switch (sched_req_template_data_unit, sched_req_record_data_unit) {
  | (
      Sched_req_data_unit_skeleton.Fixed({
        task_seg_related_data: size1,
        start: start1,
...
let sched_req_template_matches_sched_req_record_data =
    (
      sched_req_template: Task.sched_req_template,
      sched_req_record_data: Sched_req.sched_req_record_data,
    )
    : bool =>
  List.for_all2(
